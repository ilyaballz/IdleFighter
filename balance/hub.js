...
export const BUILDING_UNLOCK_LOCATION = {
  ...
  wardrobe: 2,   // после L1
  gym:      3,   // после L2
  house:    4,   // после L3 — открывается с Трейлером, остальные постройки разлочиваются позже
  stickers: 8,   // после L7 — коллекционная фича на лейт
  bar:      6,   // после L5 — ранний источник павера, на "пустую" локу (без forced паков)
  shop:     9,   // после L8 — sink монет (энергетики/стероиды/билеты/шарды/гача/эссенция/стикеры)
};
